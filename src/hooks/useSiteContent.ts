...
<p>Tickerbird(이하 "회사")는 이용자의 개인정보를 중요시하며, 「개인정보 보호법」을 준수하고 있습니다.</p>
...
<h2>7. 개인정보 보호책임자</h2>
<p>이메일: privacy@tickerbird.com</p>
...
<h2>제1조 (목적)</h2>
<p>본 약관은 Tickerbird(이하 "회사")가 제공하는 서비스의 이용 조건 및 절차, 회사와 이용자의 권리, 의무, 책임사항 등을 규정함을 목적으로 합니다.</p>
