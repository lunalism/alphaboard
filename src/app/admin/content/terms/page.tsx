...
export default function AdminTermsPage() {
  ...
  const { content, isLoading, isSaving, error, saveContent } = useSiteContent('terms');
    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 dark:text-gray-400">
          서비스 이용약관을 작성하고 저장합니다. 마크다운 문법을 지원합니다.
        </p>
      </div>
